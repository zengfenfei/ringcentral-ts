...
interface UpdateAccountRequest {
	...
	/**
	 * Target account status. For account activation - 'Unconfirmed'. 
	 * For account confirmation - 'Confirmed'. 
	 * For changing account status - 'Confirmed' or 'Disabled' = [
	 * 'Unconfirmed', 
	 * 'Confirmed', 
	 * 'Disabled'],
	 */
	 ...
	 * developed and applied on the client side
	 */
	partnerId?: string;
