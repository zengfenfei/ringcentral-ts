...
interface PagingInfo {
	...
	/**
	 * The current page number. 1-indexed, so the first page is 1 by default. 
	 * May be omitted if result is empty (because non-existent page was specified or perPage=0 was requested)
	 */
	page?: number;
	 ...
	 * If perPage value in the request is greater than 1000, the maximum value (1000) is applied
	 */
	perPage?: number;
	 ...
	 * May be omitted for some resources due to performance reasons
	 */
	totalPages?: number;

	/**
	 * The total number of elements in a dataset. 
	 * May be omitted for some resource due to performance reasons
	 */
